...
export default function Home() {
  ...
  return (
       <main>
            ...
            <section id="slider" class=" text-light text-center p-4" style={{height: '1000px' ,backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),url(' + Imagehero + ')' }}>
            ...
            <section class="row justify-content-center">
                <div class="card" style={{width: '80rem',marginBottom: '50px',marginTop: '50px'}} >
                 ...
                 <div class="row justify-content-center" id="aprops">
                    ...
                    <div class=" col-md-6">
                        <img src={Imagerepre} alt="espace bien-être" />
