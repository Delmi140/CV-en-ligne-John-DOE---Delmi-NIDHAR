  ...
  return (
    <main>
      <section id="slider" class="imagehero text-light text-center p-4">
        <h1 class="text-uppercase mb-3 " style={{ marginTop: "10%" }}>
          Bonjour, je suis John Doe
        </h1>
        <h2>Développeur web full stack</h2>
        <a href="#aprops" class="btn btn-primary">
          En savoir plus
        </a>
      </section>
      ...
      <section class="row justify-content-center">
        <div
          class="card"
          style={{ width: "80rem", marginBottom: "50px", marginTop: "50px" }}
        >
          <div class="card-body">
            <div class="row justify-content-center" id="aprops">
              <div class=" col-md-6">
                ...
                <p>
                  ...
                  <strong>développement web</strong>. <br /> Basé à Lyon, je
                  suis en recherche d'une alternance au sein d'une agence
                  digitale pour consolider ma formation de{" "}
                  <strong>développeur web full stack</strong>. <br /> J'accorde
                  une attention particulière à la qualité du code que j'écris et
                  je respecte les bonnes pratiques du web.
                </p>
              </div>
              <div class=" col-md-6">
                <div class="imagerep"></div>
