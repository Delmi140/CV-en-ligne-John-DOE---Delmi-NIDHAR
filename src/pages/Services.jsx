      ...
      <div class="text-center ">
            ...
            <section>
                ...
                <div class="row justify-content-center"> 
                    <div class="card col-md-6 col-lg-4 mb-5" style={{width: '25rem', paddingBlockStart: '100px', paddingBlockEnd: '100px',marginBlockStart: '50px',marginLeft:'35px',marginRight:'35px' }}>
